...
function showNotification(image, message, title, url) {
    return __awaiter(this, void 0, void 0, function* () {
        const desktopNotificationResult = yield desktop_notification_helper_1.DesktopNotificationHelper.show(image, message, title, url);
        if (!desktopNotificationResult) {
            toastr_notification_helper_1.ToastrNotificationHelper.show(image, message, title, url);
        }
    });
}
...
class ToastrNotificationHelper {
    static show(image, message, title, url) {
